...
img.paste(foreground, (x_3-80, y_2), foreground)
img.paste(foreground, (x_4-80, y_2), foreground)
img.paste(foreground, (x_5-80, y_2), foreground)
...
img.paste(foreground, (x_2-100, y_2), foreground)
img.paste(foreground, (x_2-100, y_3+150), foreground)
img.paste(foreground, (x_3-80, y_3+150), foreground)
img.paste(foreground, (x_4-80, y_3+150), foreground)
img.paste(foreground, (x_5-80, y_2), foreground)
img.paste(foreground, (x_5-80, y_3+150), foreground)
...
img.save(f'img/lucifer_shape_hello.png')
